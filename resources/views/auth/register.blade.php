        ...
        <div class="col-11 col-sm-8 col-md-6 col-lg-5 col-xl-4 p-0">
            <div class="jmk-card my-5">
                <div class="jmk-header">
                    <h2 class="jmk-logo-text mb-2">KarcisDigital</h2>
                    <p class="jmk-subtitle">Join the Official Fan Portal</p>
                </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group mb-4 px-0">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" name="name" id="name" class="form-control form-control-lg @error('name') is-invalid @enderror" value="{{ old('name') }}" required autofocus placeholder="Enter your name">
                            </div>
                            @error('name')
                        ...
                        <div class="form-group mb-4 px-0">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="email" name="email" id="email" class="form-control form-control-lg @error('email') is-invalid @enderror" value="{{ old('email') }}" required placeholder="Enter your email">
                            </div>
                            @error('email')
                                <div class="invalid-feedback d-block fw-bold">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                        ...
                        <div class="form-group mb-4 px-0">
                            ...
                            <div class="input-icon position-relative">
                                ...
                                <input type="password" name="password" id="password" class="form-control form-control-lg @error('password') is-invalid @enderror" required placeholder="Choose a password">
                        ...
                        <div class="form-group mb-5 px-0">
                            <label for="password_confirmation" class="form-label fw-bold text-dark d-flex justify-content-between align-items-center">
                                Confirm Password
                            </label>
                            <div class="input-icon position-relative">
                                <span class="input-icon-addon">
                                ...
                                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control form-control-lg" required placeholder="Confirm your password">
                            </div>
                        </div>
                        ...
                        <div class="text-center mt-3">
                            <span class="text-muted fw-bold">Sudah memiliki akun? <a href="{{ route('login') }}" class="jmk-link">Login!</a></span>
                        </div>
                    </form>
                </div>
            </div>
